    ...
    <main style={{ fontFamily: "serif", backgroundColor: "#f5f1eb", color: "#2d2d2d" }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{ marginTop: "12px", letterSpacing: "2px" }}>
          ...
          <p style={{
            ...
            A thoughtful clinical space for listening,
      ...
      <section id="about" style={{
        ...
        <p style={{ lineHeight: "1.8", marginTop: "20px" }}>
          ...
          Sexual Diversity and Gender at IPPERG. As a student at Fórum Lacan São Paulo,
      ...
      <section id="contact" style={{
        ...
        <p style={{ marginTop: "20px" }}>
          Email:
          <a href="mailto:pyspatajjouri@gmail.com" style={{ marginLeft: "8px" }}>
        ...
        <p>
          WhatsApp:
          <a href="https://wa.me/551199816969" style={{ marginLeft: "8px" }}>
            +55 11 99816-969
          </a>
        </p>
      ...
      <footer style={{
        ...
        <p>Patricia Ajjouri — Clinical Psychologist</p>
        <p>Online Psychotherapy</p>
        <p>© 2026 Patricia Ajjouri</p>
